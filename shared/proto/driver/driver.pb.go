...
func (x *DriverRequest) GetPackageSlug() string {
	if x != nil {
...
func (x *DriverResponse) GetDriver() *Driver {
	if x != nil {
		return x.Driver
	}
	return nil
...
const file_driver_proto_rawDesc = "" +
	...
	"\tlongitude\x18\x02 \x01(\x01R\tlongitude2\x93\x01\n" +
	"\rDriverService\x12?\n" +
	"\x0eRegisterDriver\x12\x15.driver.DriverRequest\x1a\x16.driver.DriverResponse\x12A\n" +
	"\x10UnregisterDriver\x12\x15.driver.DriverRequest\x1a\x16.driver.DriverResponseB\x1cZ\x1ashared/proto/driver;driverb\x06proto3"
...
var file_driver_proto_depIdxs = []int32{
	2, // 0: driver.DriverResponse.driver:type_name -> driver.Driver
	3, // 1: driver.Driver.location:type_name -> driver.Location
	0, // 2: driver.DriverService.RegisterDriver:input_type -> driver.DriverRequest
	0, // 3: driver.DriverService.UnregisterDriver:input_type -> driver.DriverRequest
	1, // 4: driver.DriverService.RegisterDriver:output_type -> driver.DriverResponse
	1, // 5: driver.DriverService.UnregisterDriver:output_type -> driver.DriverResponse
