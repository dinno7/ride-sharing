...
type DriverServiceClient interface {
	RegisterDriver(ctx context.Context, in *DriverRequest, opts ...grpc.CallOption) (*DriverResponse, error)
	UnregisterDriver(ctx context.Context, in *DriverRequest, opts ...grpc.CallOption) (*DriverResponse, error)
}
...
func (c *driverServiceClient) RegisterDriver(ctx context.Context, in *DriverRequest, opts ...grpc.CallOption) (*DriverResponse, error) {
...
func (c *driverServiceClient) UnregisterDriver(ctx context.Context, in *DriverRequest, opts ...grpc.CallOption) (*DriverResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DriverResponse)
...
type DriverServiceServer interface {
	RegisterDriver(context.Context, *DriverRequest) (*DriverResponse, error)
	UnregisterDriver(context.Context, *DriverRequest) (*DriverResponse, error)
...
func (UnimplementedDriverServiceServer) RegisterDriver(context.Context, *DriverRequest) (*DriverResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterDriver not implemented")
}
func (UnimplementedDriverServiceServer) UnregisterDriver(context.Context, *DriverRequest) (*DriverResponse, error) {
...
func _DriverService_RegisterDriver_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DriverServiceServer).RegisterDriver(ctx, req.(*DriverRequest))
	}
...
func _DriverService_UnregisterDriver_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DriverServiceServer).UnregisterDriver(ctx, req.(*DriverRequest))
	}
	return interceptor(ctx, in, info, handler)
}
