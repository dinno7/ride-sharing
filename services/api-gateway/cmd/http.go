...
// func tripPreview(w http.ResponseWriter, r *http.Request) {
// 	r.Body = http.MaxBytesReader(w, r.Body, 5*1024*1024)
// 	p, err := validator.ValidateHttpBody[HTTPTripPreviewRequestPayload](r)
// 	if err != nil {
// 		util.HttpValidationErrorResponse(w, err.Error())
// 		return
// 	}
//
// 	// TODO: Send to service
// 	client := new(http.Client)
// 	jsonToService, _ := json.Marshal(p)
// 	reader := bytes.NewReader(jsonToService)
// 	req, err := http.NewRequest(http.MethodPost, "http://trip-service:7000/preview", reader)
// 	if err != nil {
// 		util.ErrorResponse(
...
//
// 	// TODO: Send success response
// 	util.HttpOkResponse(w, "Trip created successfully", string(b))
// }
